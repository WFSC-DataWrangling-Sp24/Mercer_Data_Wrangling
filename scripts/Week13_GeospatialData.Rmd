...
temp <- rast("../data_raw/global_temperature.tif")
```
...
plot(temp)
# you need to install tidyterra if you want to use terra and ggplot!!
# sf and ggplot come built in
```
...
prec <- rast("../data_raw/global_precipitation.tif")
prec
plot(prec)
```
